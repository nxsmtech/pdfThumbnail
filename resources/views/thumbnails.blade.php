...
<head>
    ...
    <style>
        ...
        .thumbnail-content .content-overlay {
        ...
        .thumbnail-content:hover .content-overlay{
            opacity: 1;
        }
        ...
        .thumbnail-content:hover .content-details{
            top: 50%;
            left: 50%;
            opacity: 1;
        }
            ...
            <span id="uploaded_file">
                 @foreach($thumbnails as $thumbnail)
                    <div class="thumbnail-content">
                        ...
                        <img class="thumbnail-content-image" src="{{asset("files/thumbnails/" . $thumbnail->getRelativePathname())}}" class="img-thumbnail"
                            width="300" alt="image"/>
